...
void SV_Init (void)
{
	...
	allow_download_models = Cvar_Get ("allow_download_models", "0", CVAR_ARCHIVE);
	allow_download_sounds = Cvar_Get ("allow_download_sounds", "0", CVAR_ARCHIVE);
	allow_download_maps	  = Cvar_Get ("allow_download_maps", "0", CVAR_ARCHIVE);
